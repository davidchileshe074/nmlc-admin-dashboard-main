    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-slate-500 mt-1">Platform performance and latest metrics.</p>
            </div>
                ...
                {kpis.map((kpi, idx) => (
                  ...
                  12%
                            ...
                            <div className="mt-4">
                                ...
                                <h3 className="text-2xl font-bold text-slate-900 mt-1">{kpi.value.toLocaleString()}</h3>
                            </div>
                        </CardContent>
                    </Card>
                ))}
